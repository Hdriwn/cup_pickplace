...
/*  
  tf2::Quaternion orientation(0.0, 0.0, 0.0, 1.0); // Set the quaternion values (x, y, z, w)
  grasps[0].grasp_pose.pose.orientation = tf2::toMsg(orientation);
  grasps[0].grasp_pose.pose.position.x = -0.04;
  grasps[0].grasp_pose.pose.position.y = 4.70;
...
grasps[0].grasp_pose.pose.orientation = tf2::toMsg(orientation);
  ...
  grasps[0].grasp_pose.pose.position.z = 0.8;
...
for (const auto& grasp : grasps) {
  ...
  std::cout << "Position: x=" << grasp.grasp_pose.pose.position.x
            << ", y=" << grasp.grasp_pose.pose.position.y
            << ", z=" << grasp.grasp_pose.pose.position.z << std::endl;
  std::cout << "Orientation: x=" << grasp.grasp_pose.pose.orientation.x
            << ", y=" << grasp.grasp_pose.pose.orientation.y
            << ", z=" << grasp.grasp_pose.pose.orientation.z
            << ", w=" << grasp.grasp_pose.pose.orientation.w << std::endl;
